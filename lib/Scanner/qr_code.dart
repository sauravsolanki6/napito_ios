...
import '../main.dart';
import 'qr_animation.dart'; // Import the BlinkingBorder widget
...
class _QrCodePageState extends State<QrCodePage> {
  ...
  Future<void> _clearPreferences() async {
    ...
    await prefs.remove('scanned_code');
  }
  ...
  void didChangeDependencies() {
    ...
    // Reset to camera icon being blue whenever dependencies change or state is rebuilt
    setState(() {
      _activeIcon = 'camera';
    });
  }
                        ...
                        child: GestureDetector(
                          onTap: () {
                            setState(() {
                              ...
                              _activeIcon =
                                  'camera'; // Reset the camera icon to blue
                            });
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              setState(() {
                                _activeIcon =
                                    'upload'; // Set active icon to 'upload'
                                _isCameraOpen = false;
                              });
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              setState(() {
                                _activeIcon =
                                    'camera'; // Set active icon to 'camera'
                        ...
                        onPressed: () async {
                          ...
                          if (_isConnected) {
                            Navigator.pushReplacementNamed(
                                context, '/qr'); // Navigate to homepage
                          }
                        },
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse['status'] == 'true') {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Invalid store code. Please Try Again.'),
              backgroundColor: Colors.red,
              duration:
                  Duration(milliseconds: 300), // Set the duration to 100 ms
            ),
          );
        }
      } else {
