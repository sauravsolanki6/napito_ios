...
// Main page widget
class SpaServicePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          SpaItem(
            imageAsset: 'assets/spa1.png',
            title: 'Ayurvedic Spa',
            description: 'Creating a balance between your mind',
            price: '₹150',
            duration: '00:30 min',
          ),
          SizedBox(height: 10),
          SpaItem(
            imageAsset: 'assets/spa1.png',
            title: 'Nordic Spa',
            description: 'Outdoor experiences such as hot tubs',
            price: '₹100',
