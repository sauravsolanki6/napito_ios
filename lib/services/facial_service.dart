...
class FacialItem extends StatelessWidget {
...
// Main page widget
class FacialServicePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          FacialItem(
            ...
            description: 'Include scars, blackheads and whiteheads',
            price: '₹100',
