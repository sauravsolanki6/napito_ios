...
class KeratinItem extends StatelessWidget {
...
// Main page widget
class KeratinServicePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          KeratinItem(
            imageAsset: 'assets/hairstyle3.png',
            title: 'Blunt Haircut',
          ...
          KeratinItem(
            ...
            description: 'A baby haircut softer and more natural',
            price: '₹100',
