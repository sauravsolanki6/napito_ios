...
class _TermsConditionsState extends State<TermsConditions> {
  late Future<List<String>> _termsConditionsData;

  @override
  void initState() {
    super.initState();
    _termsConditionsData = _fetchTermsConditionsData();
  }

  Future<List<String>> _fetchTermsConditionsData() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('${Config.apiUrl}customer/terms-conditions/'),
      ...
      await errorLogger.logError(
        ...
        errorLocation: "Function -> _fetchTermsConditionsData",
        userId: salonID,
        receiverId: "System",
        stackTrace: stackTrace,
      );

      print('Error in _fetchTermsConditionsData: $e');
      print('Stack Trace: $stackTrace');

      // Optionally, rethrow the exception or return an empty list
      throw Exception('Error during terms and conditions API call: $e');
    }
  }
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Shimmer.fromColors(
                    ...
                    child: const TermsConditionsItemShimmer(),
                  );
                },
              );
...
class TermsConditionsItemShimmer extends StatelessWidget {
  const TermsConditionsItemShimmer({super.key});
