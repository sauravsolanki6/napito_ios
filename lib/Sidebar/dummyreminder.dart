...
//           'buzzer'), // without the .mp3 extension
//     );
...
//     await audioPlayer.play(AssetSource('buzzer.mp3')); // Corrected here

//     // Trigger vibration
//     if (await Vibrate.canVibrate) {
//       Vibrate.vibrate();
//       // No timer, vibration will continue until the system decides to stop it
//     }
//   }
...
//               // Show a Snackbar indicating that reminders were canceled
//               ScaffoldMessenger.of(context).showSnackBar(
//                 SnackBar(
//                   content: Text('Reminders have been canceled.'),
//                   duration: Duration(seconds: 3),
//                 ),
//               );
//             } else {
//               // Schedule the notification if a reminder option is selected
...
//               Duration timeDifference = reminderTime.difference(DateTime.now());

//               // Schedule the notification and vibration after the delay
//               Future.delayed(timeDifference, () async {
//                 await _showNotification(_selectedReminder);
//                 await _playReminderSoundAndVibrate();
//               });

//               print('Reminder set for: $_selectedReminder at $reminderTime');
//               ScaffoldMessenger.of(context).showSnackBar(
//                 SnackBar(
//                   content: Text(
