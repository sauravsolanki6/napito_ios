...
class BookingDetailsCancelledPage extends StatefulWidget {
  @override
  _BookingDetailsCancelledPageState createState() =>
      _BookingDetailsCancelledPageState();
}

class _BookingDetailsCancelledPageState
    extends State<BookingDetailsCancelledPage> {
                              ...
                              children: [
                                ...
                                if (data['total_product_price'] != null &&
                                  ...
                                  _buildDetailRow('Total Product Price',
                                      '₹${data['total_product_price']}'),
                                if (allDiscountDetails[
                                            'mem_service_discount'] !=
                                        null &&
                                    double.tryParse(allDiscountDetails[
                                                'mem_service_discount']
                                            .toString()) !=
                                        null &&
                                    double.tryParse(allDiscountDetails[
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // _buildDetailRow('Price', '₹${service['final_price']}'),
